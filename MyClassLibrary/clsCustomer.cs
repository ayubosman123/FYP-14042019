...
namespace MyClassLibrary
{
    ...
    //public clsCustomer(string UserName)
    //{
    //        // create an insance of the class
    //        // clsCustomer Thiscustomer = new clsCustomer(UserName.Identity.Name);
    ...
    //}
        ...
        public string AllDetails
        {
            ...
            {
                //return private data
                return mTitle + ("FirstName " + mFirstName + " Surname " + mSurname + " dateOfBirth " + mdateOfBirth + " Gender " + mGender + " ContactNumber " + mContactNumber + " EMail " + mEMail + " HouseNo " + mHouseNo + " Postcode " + mPostCode);
            }
            set
            {
                //set the the value of the private memeber
